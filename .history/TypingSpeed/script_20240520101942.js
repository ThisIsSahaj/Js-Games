const data = [
  ...
  "It's estimated that human beings only use 10% of their brain's capacity. Imagine if we could access 100%. Interesting things begin to happen. All this knowledge, you could unlock secrets that go beyond out limiters. I'm not even sure that mankind is ready for it."
];
